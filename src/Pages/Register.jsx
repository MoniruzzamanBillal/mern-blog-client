    ...
    <div className="registerContainer">
      <div className="registerWraper py-8 bg-[url('https://i.ibb.co/6bsNLj8/hosting-login.jpg')] bgImage flex justify-center items-center ">
        ...
        <motion.div
          ...
          className="registerCard  bg-white  shadow-2xl  py-9 px-4 w-[92%] xsm:w-[86%] sm:w-[78%] md:w-[72%] xmd:w-[65%] lg:w-[55%] rounded-md border border-gray-200  "
        >
          <motion.h1
            ...
            className=" text-3xl font-medium text-center mb-11 "
          >
            Register{" "}
          </motion.h1>
          <form
          ...
          >
            ...
            <motion.div
              ...
              className="userInput flex flex-col gap-1 "
            >
            ...
            <motion.div
              ...
              className="userImage flex flex-col gap-1  "
            >
            ...
            <motion.div
              ...
              className="emailInput flex flex-col gap-1 "
            >
            ...
            <motion.div
              ...
              className="passwordInput flex flex-col gap-1 "
            >
            ...
            <motion.div
              ...
              className="confirmPassword flex flex-col gap-1"
            >
          ...
          <motion.div
            ...
            whileInView={"animate"}
            transition={{ duration: 0.3, delay: 0.3 }}
            className="registerDivert  mt-5 text-lg text-center  "
          >
            <p>
